const { controllerCreateActivity, controllerGetActivities, controllerDeleteActivity } = require("../controllers/activityController");
...
const postActivity = async (req, res) => {
    ...
    try {
        ...
        if(
            error.message === "The activity already exist" ||
            error.message === "The activity must have at least one contry"
        ) {
